<template>
  <form v-if="!loading" class="form" @submit.prevent="onSubmit">
    <div class="input-field">
      ...
      >
      <span class="helper-text" data-error="Todo title must not be empty"></span>
    </div>
    <div class="input-field">
      <input placeholder="Enter your Description" type="text" name="body" v-model="body" :class="[errors.body ? 'invalid' : 'validate']">
      <span class="helper-text" data-error="Description must not be empty"></span>
    </div>
